...
class CreateWeeklyAverageRecordingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('weekly_average_recordings', function (Blueprint $table) {
            $table->increments('id');
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('weekly_average_recordings');
    }
}
