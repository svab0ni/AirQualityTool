...
class CreateAirQualityRecordingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('air_quality_recordings', function (Blueprint $table) {
            $table->increments('id');
            $table->timestamps();

            $table->integer('air_quality_index')->nullable()->default(null);
    ...
    {
        Schema::dropIfExists('air_quality_recordings');
    }
}
